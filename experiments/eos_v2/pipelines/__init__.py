"""EOS v2 adversary pipelines.

Implemented AFTER the catalogue was sealed (Commit A;
seal_sha256 = see SEAL.txt). All pipelines have signature

    f(inp: Input, replay_idx: int) -> int

returning a score in [0, 100]. Determinism is per-call: the same
