# meridian — v0.4 prototype diagnosis

**Morning baseline:** pre-seed
**Prototype canonical baseline:** pre-seed
**Replays:** ['pre-seed', 'pre-seed', 'seed', 'pre-seed', 'seed']
**σ_c (noise floor):** 0.6
**Morning labeled-run sensitivity (gate_rule swap):** 1.000

## paragraph-level
- raw sensitivity (all perts):   0.05263157894736842
- raw sensitivity (delete only): 0.0
- calibrated (all):              0.0
