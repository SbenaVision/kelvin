...
EXPECTED_ENTRY_IDS: frozenset[str] = frozenset({
    ...
    "config.retry_policy_not_mapping",
    "config.retry_policy_max_attempts_invalid",
    "config.retry_policy_initial_delay_invalid",
    "config.retry_policy_backoff_factor_invalid",
    "config.retry_policy_jitter_max_invalid",
    "config.retry_policy_transient_codes_invalid",
    "config.retry_policy_retry_on_timeout_invalid",
    # runner
    "runner.timeout",
    "runner.exit_nonzero",
    "runner.output_missing",
    "runner.output_unreadable",
    "runner.output_not_json",
    "runner.output_not_mapping",
